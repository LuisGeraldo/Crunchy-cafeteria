...
@NamedQueries({
    ...
    , @NamedQuery(name = "EstadoFactura.findById", query = "SELECT e FROM EstadoFactura e WHERE e.id = :id")
...
public class EstadoFactura implements Serializable {
    ...
    public EstadoFactura(Integer id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "entidades.EstadoFactura[ id=" + id + " ]";
    }
